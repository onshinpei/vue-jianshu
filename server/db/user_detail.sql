...
CREATE TABLE `user_detail` (
  ...
  `signature` char(60) DEFAULT NULL COMMENT '用户签名',
  ...
  `favor` char(30) DEFAULT NULL COMMENT '爱好',
  `level` smallint(6) NOT NULL DEFAULT '1' COMMENT 'QQ等级',
  `profile_bg` char(30) DEFAULT NULL COMMENT '个人名片背景',
  `login_day` smallint(10) NOT NULL DEFAULT '0' COMMENT '登陆天数',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='用户信息详情';
